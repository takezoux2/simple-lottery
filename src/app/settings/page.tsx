            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <button
                    type="button"
                    onClick={() => setFormAnimationType("card")}
                    className={`p-3 rounded-xl border text-left flex items-start gap-3 transition-all ${
                      formAnimationType === "card"
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5 leading-relaxed">
                        結果ボックス内で項目が高速で切り替わるシンプル＆クイックな演出
                      </span>
                    </div>
                  </button>
                  ...
                  <button
                    type="button"
                    onClick={() => setFormAnimationType("wheel")}
                    className={`p-3 rounded-xl border text-left flex items-start gap-3 transition-all ${
                      formAnimationType === "wheel"
                        ? "border-indigo-500 bg-indigo-50/60 dark:bg-indigo-950/40 text-indigo-950 dark:text-indigo-100 ring-2 ring-indigo-500/20 shadow-sm"
                        : "border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800/30 text-slate-600 dark:text-slate-400 hover:border-slate-300 dark:hover:border-slate-600"
                    }`}
                  >
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5 leading-relaxed">
                        比率に応じた扇形の円盤が回転して結果を指す臨場感あるダイナミック演出
                      </span>
                    </div>
                  </button>
                </div>
